...
import com.liyang.helloadmin.application.util.JsonUtil;
...
public final class ResponseUtil {
    ...
    public static HttpHeaders getAuthorizationHeaders(String jwt) {
        val httpHeaders = new HttpHeaders();
        httpHeaders.add(
            HttpHeaders.AUTHORIZATION,
            OAuth2AccessToken.TokenType.BEARER.getValue() + OneChars.SPACE + jwt
        );
        return httpHeaders;
    }
}
