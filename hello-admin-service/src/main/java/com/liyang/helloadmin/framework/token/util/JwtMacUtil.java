...
public final class JwtMacUtil {
    ...
    private static JWTClaimsSet getJwtClaimsSet(Map<String, Object> optionalClaimsMap) {
    ...
    private static String createJwt(Map<String, Object> optionalClaimsMap) {
    ...
    public static String createJwt(String username) {
        ...
        optionalClaimsMap.put(JwtClaimKeys.USERNAME, username);
    ...
    public static String getVerifiedUsername(String jwt) {
        val verifiedSignedJwtClaimsSet = getVerifiedJwtClaimsSet(jwt);
        try {
            return verifiedSignedJwtClaimsSet.getStringClaim(JwtClaimKeys.USERNAME);
