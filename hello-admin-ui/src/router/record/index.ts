...
export const ROUTE_RECORD_MAIN_NOTE = {
  name: uid(),
  path: "/note",
  component: () => import("pages/main/NotePage.vue"),
} as const;
    ...
    children: [
      {
        ...
        meta: { icon: "mdi-login", label: "登录", caption: "", cached: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { icon: "mdi-home", label: "主页", caption: "", cached: true },
      },
      {
        ...ROUTE_RECORD_MAIN_NOTE,
        meta: { icon: "mdi-note", label: "说明", caption: "", cached: true },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        meta: { icon: "mdi-home", label: "404", caption: "", cached: true },
      },
    ],
  },
];
